...
const RestaurantCard = (props) => {
  ...
  return (
    <div className="p-4 m-5 w-[95%] md:w-[90%] md:h-auto bg-gray-200 rounded-lg cursor-pointer hover:bg-gray-300 transition-all">
      <div>
        <img
          className="w-full h-[150px] md:h-[200px] rounded-lg"
